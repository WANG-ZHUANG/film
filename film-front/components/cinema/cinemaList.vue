    ...
    <div class="cinemaList-container" v-if="cinemasItem && cinemasItem.data">
        ...
        <div class="show-list" v-for="(item, index) in cinemasItem.data.filmList" v-show="tabShow==index" :key="index">
            <div class="movie-info">
                <div>
                    <h3 class="movie-name">{{item.filmInfo.filmName}}</h3>
                ...
                <div class="movie-desc">
                    <div>
                        ...
                        <span class="value">{{item.filmInfo.filmLength}}</span>
                    </div>
                    <div>
                        <span class="key">类型 :</span>
                        <span class="value"> {{item.filmInfo.filmCats}} </span>
                    </div>
                    <div>
                        <span class="key">主演 :</span>
                        <span class="value"> {{item.filmInfo.actors}}</span>
                    </div>
                </div>
            </div>
            <div class="show-date">
            ...
            <div class="plist-container">
                <table class="plist">
                    ...
                    <tbody>
                    <tr v-for="(filmFields, index) in item.filmInfo.filmFields" :key="index">
                        <td>
