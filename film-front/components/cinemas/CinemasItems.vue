<template>
    <div class="cinema-wrapper">
        <div class="cinema-list">
            ...
            <div class="has-movies" v-if="cinemasData.filmInfo && cinemasData.filmInfo.length > 0">
                <div v-for="(cinema,index) in cinemasData.filmInfo" :key="index" class="cinema-cell">
...
<script>
    ...
    function getCinemaListQueryParams (content) {
        return {
            ...
            districtId: content.$router.history.current.query.districtId || 99,
