    ...
    <div class="tags-panel">
        <ul class="tags-lines">
            <li class="tags-line">
                ...
                <ul class="tags">
                    <li v-for="(cat, index) in quickSearch.catInfo" :key="index+'-cat'" :class="{'active': catActive == cat.catId}" @click="selectCat(cat.catId)">
            ...
            <li class="tags-line">
                ...
                <ul class="tags">
                    <li v-for="(source, index) in quickSearch.sourceInfo" :key="index+'-source'" :class="{'active': sourceActive == source.sourceId}" @click="selectSource(source.sourceId)">
                        <nuxt-link :to="{path:'/films'}">
                            {{source.sourceName}}
                        </nuxt-link>
                    </li>
            ...
            <li class="tags-line">
                ...
                <ul class="tags">
                    <li v-for="(year, index) in quickSearch.yearInfo" :key="index+'-year'" :class="{'active': yearActive == year.yearId}" @click="selectYear(year.yearId)">
                        <nuxt-link :to="{path:'/films'}">
                            {{year.yearName}}
                        </nuxt-link>
                    </li>
